...
// import PortfolioSection from "/src/vue/content/sections/PortfolioSection.vue"  // ELIMINADO
...
const sections = [
    ...
    new SectionInfo('history',      HistorySection,         'Historia',         'pi pi-clock'),
    new SectionInfo('featured',     FeaturedProjectSection, 'Disponible',       'pi pi-qrcode'),
    // Portfolio ELIMINADO - No es contenido propio
